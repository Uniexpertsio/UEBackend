...
const staffMailTemplate = (mailBody) => {
    const {companyName, mail, branchName, password} = mailBody;
    return `<!DOCTYPE html>
    <html>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    Direct Phone: {{{Sender.Phone}}}<br /> -->
                                                                            ...
                                                                            <p>Your admin have added you to the portal</p>
    
                                                                            <p>Company Name :${companyName}</p>
                                                                            <p>Branch : ${branchName}</p>
                                                                            <p>User Name : ${mail}</p>
                                                                            <p>Password : ${password}</p>
                                                                            <p>Web URL : www.uniexperts.app</p>
                                                                                <span>With love,</span>
                                                                                <span>Happy Recruiting</span>
                                                                                <span>Uniexperts</span>
                                                                                </p>
...
module.exports = { otpMailTemplate, staffMailTemplate }