...
router.put('/:studentId/general-information', Middleware.checkAuth, studentController.updateStudentGeneralInformation.bind(studentController));
...
router.put('/:studentId/education/:educationId', Middleware.checkAuth, studentController.updateStudentEducation.bind(studentController));
...
router.put('/:studentId/work-history/:workHistoryId', Middleware.checkAuth, studentController.updateStudentWorkHistory.bind(studentController));
...
router.put('/:studentId/test-score/:testScoreId', Middleware.checkAuth, studentController.updateStudentTestScore.bind(studentController));
...
router.get('/partnerId/:studentId',Middleware.checkAuth, studentController.getPartnerId.bind(studentController));
