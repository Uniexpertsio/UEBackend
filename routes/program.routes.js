...
router.put("/", Middleware.checkAuth, programController.addOrUpdateProgram);
...
router.get(
  "/:programId/similar",
  Middleware.checkAuth,
  programController.getSimilarProgram
);
...
router.get(
  ...
  Middleware.checkAuth,
  programController.getProgramByCountryAndDiscipline
);
...
router.post(
  "/program/createEligibility",
  Middleware.checkAuth,
  programController.createEligibility
);
