...
const {acceptTnc, getGeneralInformation, updateGeneralInformation, getBankInformation, updateBankInformation, getAccountManager, getDocuments, updateDocuments, updateDocument } = require("../controllers/Agent");
