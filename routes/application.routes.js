...
router.post(
  ...
  applicationController.addApplication.bind(applicationController)
);
router.get(
  "/",
  Middleware.checkAuth,
...
router.get(
  "/:applicationId/task",
  Middleware.checkAuth,
  applicationController.getTasks.bind(applicationController)
);
router.patch(
  "/:applicationId/task/:taskId",
  Middleware.checkAuth,
  applicationController.updateTask.bind(applicationController)
);
router.get(
  "/:applicationId/task/:taskId/comment",
  Middleware.checkAuth,
  applicationController.getTaskComments.bind(applicationController)
);
router.post(
  "/:applicationId/task/:taskId/comment",
  Middleware.checkAuth,
  applicationController.addTaskComment.bind(applicationController)
);
router.get(
...
router.get(
  ...
  Middleware.checkAuth,
  applicationController.getStudentDocuments.bind(applicationController)
);
router.post(
  "/:applicationId/payment",
  Middleware.checkAuth,
  applicationController.addOrUpdatePayment.bind(applicationController)
);
router.get(
  "/:applicationId/payment",
  Middleware.checkAuth,
  applicationController.getPayments.bind(applicationController)
);
router.get(
  "/:applicationId",
  Middleware.checkAuth,
