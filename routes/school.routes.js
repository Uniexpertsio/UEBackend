...
router.put("/", Middleware.checkAuth, schoolController.addOrUpdateSchool.bind(schoolController));
...
router.get("/programList/:schoolId", schoolController.getSchoolProgram.bind(schoolController));
