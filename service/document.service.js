...
class DocumentService {
  ...
  async getSfDataStudentId(studentId) {
    ...
    const url = `${process.env.SF_API_URL}services/data/v50.0/query?q=SELECT+Id,Name,Description__c,Document_Category__c,ContentUrl__c,ReviewRemarks__c,Status__c,Used_For__c,Sequence__c,Mandatory__c+FROM+DMS_Documents__c+WHERE+Student__c+=+'${studentData?.salesforceId}'`
